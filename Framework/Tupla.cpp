...
{
	return Comparador<T1>().SonIguales(m_Dato1, tupla.m_Dato1)
		&& Comparador<T2>().SonIguales(m_Dato2, tupla.m_Dato2)
		&& Comparador<T3>().SonIguales(m_Dato3, tupla.m_Dato3)
		&& Comparador<T4>().SonIguales(m_Dato4, tupla.m_Dato4);
}
